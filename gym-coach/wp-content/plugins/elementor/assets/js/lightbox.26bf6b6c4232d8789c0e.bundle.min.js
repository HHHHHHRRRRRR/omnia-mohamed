      ...
      e.exports = elementorModules.ViewModule.extend({
        ...
        setVideoContent(e) {
          ...
          if ("hosted" === e.videoType) {
            ...
            (n = t("<iframe>", { allowfullscreen: 1 })),
              "yes" === e.autoplay
                ? (n.attr("allow", "autoplay"),
                  n.attr("src", i.getAutoplayURL(e.url)))
                : n.attr("src", e.url);
          }
        ...
        getShareLinks() {
          const { i18n: e } = elementorFrontend.config,
            ...
            l = n("<div>", { class: i.slideshow.shareLinks }),
          ...
          if (n || i || o || l) {
            if (
              ...
              i.on("click", (e) => {
                ...
                (d.$shareMenu = t("<div>", { class: r.shareMenu }).append(i)),
                d.$iconShare
                  .add(d.$shareMenu)
            ...
            if (o) {
              ...
              this.isFontIconSvgExperiment || (l.class = r.iconZoomIn),
                (d.$iconZoom = t(n).attr(l).on("click", this.toggleZoomMode)),
                i.push(d.$iconZoom),
                this.isFontIconSvgExperiment &&
        ...
        setSlideshowContent(e) {
          ...
          if (
            (e.slides.forEach((e) => {
              ...
              if (e.video) {
                ...
                const i = this.isFontIconSvgExperiment
                    ? s.loading.element
                    : "<i>",
                  l = n("<div>", { class: r.playButton }).html(
                    n(i)
            ...
            const e = this.isFontIconSvgExperiment
              ...
              l = n("<span>", { class: "screen-reader-text" }).html(t.next);
            (m = n("<div>", {
          ...
          p.onShow = async () => {
            ...
            i || (t.navigation = { prevEl: m[0], nextEl: g[0] }),
        ...
        playSlideVideo() {
          ...
          r.onApiReady((e) => {
            ...
            l.addClass(n.playing).removeClass(n.hidden);
        },
        ...
        prepareVimeoVideo(e, t, n, i, s) {
          const o = this.getSettings("classes"),
            l = { url: t, autoplay: !0, transparent: !1, playsinline: !1 };
          (this.player = new e.Player(i, l)),
